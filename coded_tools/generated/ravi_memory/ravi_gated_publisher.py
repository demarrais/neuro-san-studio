    ...
    def _generate(
        ...
        def sanitize_for_azure(text):
            ...
            replacements = {
                ...
                'this is a moment': 'the imperative is clear',
                'seamless': 'integrated',
