...
class RaviGatedPublisher(CodedTool):
    ...
    def _query_memory(self, request: str) -> str:
        try:
            ...
            FILTER_PHRASES = [
                "BEHAVIORAL DIRECTIVE", "BLOCK these LLM", "hard editorial block",
