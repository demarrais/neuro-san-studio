...
class EditorialGateTool(CodedTool):
    ...
    def invoke(self, args: dict, sly_data: dict = None) -> dict:
        ...
        known_good = ["230", "83%", "56%", "37%", "12,000", "12k", "230k", "230,000", "2.2", "1.4", "4.4", "4.5", "93", "31", "60", "2%", "9%", "30%", "7%", "7.0%", "6.4%", "7.4%", "6.5%", "7.2%", "16.1%", "15.8%", "50%", "11%", "80%", "84%", "37%", "17%", "12-25%", "40%", "95%", "32%", "47%", "42%", "81%", "13.9%", "351,600", "350,000", "330,000", "93%", "93", "65%",
